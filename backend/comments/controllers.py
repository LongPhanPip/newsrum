...
def get_all_comments(sort, filter):
...
def get_all_comments_by_post_id(pk):
...
def get_replies_by_comment_id(pk):
...
def delete_comment_by_id(pk):
    get_comment_by_id(pk).delete()
